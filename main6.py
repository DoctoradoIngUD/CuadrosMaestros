...
#Bin
import Articulos.proyectos, Articulos.init
...
wb = openpyxl.load_workbook('./Input/Base3.xlsx')
sheet = wb['Sheet1']
...
for q in range(2,total+1):
    ...
    if my_url != '-':
        Articulos.proyectos.artiextract()
        COD_PRODUCTO = int("".join(str(x) for x in Articulos.proyectos.contarProyecto))
