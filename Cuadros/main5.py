...
#Bin
import Articulos.capituloLibro, Articulos.init
...
for q in range(2,total+1):
    ...
    if my_url != '-':
        Articulos.capituloLibro.artiextract()
        COD_PRODUCTO = int("".join(str(x) for x in Articulos.capituloLibro.contarCapitulo))
