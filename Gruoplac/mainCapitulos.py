...
#Bin
import Articulos.capitulos, Articulos.init
...
for q in range(2,total+1):
    ...
    if my_url != '-':
        Articulos.capitulos.artiextract()
        COD_PRODUCTO = int("".join(str(x) for x in Articulos.capitulos.contarCapitulos))
