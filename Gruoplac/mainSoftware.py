...
#Bin
import Articulos.software, Articulos.init
...
for q in range(2,total+1):
    ...
    if my_url != '-':
        Articulos.software.artiextract()
        COD_PRODUCTO = int("".join(str(x) for x in Articulos.software.contarSoftware))
