...
#Bin
import Articulos.articulos, Articulos.init
...
wb = openpyxl.load_workbook('./Input/Base_GruposP.xlsx')
sheet = wb['Sheet1']
...
for q in range(2,total+1):
    ...
    if my_url != '-':
        Articulos.articulos.artiextract()
        COD_PRODUCTO = int("".join(str(x) for x in Articulos.articulos.contarticulo))
